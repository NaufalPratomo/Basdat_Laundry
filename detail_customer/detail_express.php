...
<head>
    ...
    <title>Detail Express - Alesha Laundry</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container">
        <h2 class="mb-4">Detail Express</h2>
        ...
        <form action="detail_express.php" method="POST" name="detail">
            <a href="../update/update_express.php?id_cus=<?php echo $id_cus; ?>" class="btn btn-primary btn-custom">Update</a>
