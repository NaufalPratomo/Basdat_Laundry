<?php 
    ...
    if (isset($_POST['tambah'])) {
        ...
        $sql = "INSERT INTO customer_express(nama_cus, noTelp_cus, berat, harga, keterangan, tgl_keluar, garansi) VALUES ('$nama_ex', '$noTelp_ex', '$harga','$berat', '$keterangan', '$tgl_keluar', '$garansi')";
